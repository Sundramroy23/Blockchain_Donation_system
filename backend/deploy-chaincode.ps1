...
wsl -d Ubuntu bash -c 'cd /mnt/d/blockchain/fabric-samples/test-network && docker build --no-cache -f ../asset-transfer-basic/chaincode-javascript/Dockerfile -t ccc01_ccaas_image:latest --build-arg CC_SERVER_PORT=9999 ../asset-transfer-basic/chaincode-javascript'
